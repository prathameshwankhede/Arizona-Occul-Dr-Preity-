...
import { Sparkles, ShoppingBag, Menu, X, Calendar, ShieldCheck, Sun, Search } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            <span className="text-slate-400 hidden sm:inline flex items-center gap-1">
              ...
              <span>100% Lab Certified & Abhimantrit Beads</span>
            </span>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between gap-4">
          ...
          >
            ...
            <div className="text-left">
              <span className={`text-xl font-extrabold tracking-tight block leading-none ${isScrolled ? 'text-slate-900' : 'text-white'}`}>
                Arizona <span className="text-amber-500">Occult</span>
              </span>
              <span className={`text-[10px] tracking-widest uppercase font-semibold block mt-0.5 ${isScrolled ? 'text-slate-500' : 'text-slate-400'}`}>
          ...
          <div className="hidden md:flex flex-grow max-w-xs relative">
            ...
            <input
              ...
              placeholder="Search Rudraksha, Pukhraj, Pyrite..."
              className={`w-full pl-9 pr-3 py-1.5 rounded-xl border text-xs focus:outline-none focus:ring-2 focus:ring-amber-500 ${
                isScrolled ? 'bg-slate-100 border-slate-200 text-slate-800' : 'bg-slate-800 border-slate-700 text-white placeholder-slate-400'
              }`}
            />
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className={`p-2 rounded-xl xl:hidden ${
